...
public class EntityCockatrice extends MonsterBase {
    ...
    public void tick() {
        super.tick();
        this.field_1622 = (this.passenger == EntityCockatrice.mc.player);
    ...
    protected void tryAttack(final EntityBase target, final float f) {
        if (f < 10.0f) {
            ...
            if (this.attackTime == 0) {
                ...
                this.level.playSound((EntityBase)this, "mob.aether.dartshoot", 1.0f, 1.0f / (this.rand.nextFloat() * 0.4f + 0.8f));
    ...
    static {
        EntityCockatrice.mc = MinecraftClientAccessor.getMCinstance();
    }
}
