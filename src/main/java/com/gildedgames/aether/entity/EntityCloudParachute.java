...
public class EntityCloudParachute extends EntityBase {
    ...
    public static void doCloudSmoke(final Level world, final Living entityliving) {
        ...
        MinecraftClientAccessor.getMCinstance().particleManager.addParticle(new EntityCloudSmokeFX(world, x, y, z, 0.0, 0.0, 0.0, 2.5f, 1.0f, 1.0f, 1.0f));
    }
