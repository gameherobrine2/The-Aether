...
public class ItemDartShooter extends TemplateItemBase {
    ...
    public ItemInstance use(final ItemInstance item, final Level level, final PlayerBase player) {
        ...
        if (consume != -1) {
            level.playSound((EntityBase)player, "assets/aether/stationapi/aether.sound.other.dartshooter.shootdart", 2.0f, 1.0f / (ItemDartShooter.rand.nextFloat() * 0.4f + 0.8f));
